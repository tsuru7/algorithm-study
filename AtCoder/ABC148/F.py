...
def solve(n,u,v,graph):
    ...
    taka_fardepth = 0
    for u in range(n):
        if taka_fardepth < depth[u]:
            taka_fardepth = depth[u]
            taka_farest = [u]
        elif taka_fardepth == depth[u]:
            taka_farest.append(u)

    # print(f'taka_farest: {taka_farest}')
    # print(f'taka_fardepth: {taka_fardepth}')
    if taka_fardepth == 0:
        return 1
